  ...
  return (
    <Card className="w-full max-w-md mx-auto shadow-lg">
      <CardHeader className="text-center pb-6">
        ...
        <p className="text-gray-600 text-sm">Acesse sua conta para denunciar queimadas</p>
      </CardHeader>
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            {erros.email && <p className="text-red-500 text-xs mt-1 font-[Poppins]">{erros.email}</p>}
          </div>
          ...
          <div>
            ...
            {erros.senha && <p className="text-red-500 text-xs mt-1 font-[Poppins]">{erros.senha}</p>}
          </div>
          ...
          <div className="flex items-center">
            <input
              ...
              className="w-4 h-4 text-[#3f6b0d] border-gray-300 rounded focus:ring-[#3f6b0d] cursor-pointer"
              disabled={loading}
            />
            <label htmlFor="lembrarMe" className="ml-2 text-sm text-gray-700 font-[Poppins]">Lembrar-me</label>
          </div>
